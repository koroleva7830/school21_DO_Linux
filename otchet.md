...
- команда для названияназвания машины sudo hostname user-1
...
- вводим команду sudo timedatectl set-imezone Europe/Moscow  и затем снова проверяем date
...
- определить и вывести на экран внутренний IP-адрес шлюза, он же ip-адрес по умолчанию (gw), можно  командами ip route

![запущена команда ip route](img/part3_11.PNG)

- или командой route -n

![запущена команда ip route](img/part3_10.PNG)
...
- автостарт службы SSH включен автоматически
